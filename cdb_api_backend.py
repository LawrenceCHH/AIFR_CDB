...
if on_server:
    domain_setting = {'host': '0.0.0.0', 'port': 6128}
...
if on_server:
    ...
    frontend_template_dir = '/cluster/home/lawrencechh.cs/workspace/Projects/AIFR_CDB/frontend_deployment/20240630_dist'
else:
    frontend_template_dir = '/workspace/Projects/AIFR_CDB/frontend_deployment/20240630_dist'
    # # Redirect
...
if __name__ == '__main__':
    ...
    # Formal server
    uvicorn.run('cdb_api_backend:app', host=domain_setting['host'], port=domain_setting['port'], forwarded_allow_ips='*')
...
# Server
# pm2 start /cluster/home/lawrencechh.cs/workspace/Projects/AIFR_CDB/cdb_api_backend.py --name cdb --interpreter=/cluster/home/lawrencechh.cs/miniconda3/envs/chatglm2_env/bin/python
